...
TEST_CASE("List Testing", "[List]")
{
    ...
    SECTION("Hinzufügen und Suche von Nodes - simple")
    {
    ...
    SECTION("Hinzufügen von Nodes aus zweiter Liste am Ende")
    {
        test_list.insertFront(5);
        test_list.insertFront(7);
    ...
    SECTION("Hinzufügen von Nodes aus zweiter Liste am Anfang")
    {
        test_list.insertFront(5);
        test_list.insertFront(7);
    ...
    SECTION("Hinzufügen und Löschen von Nodes - simpel")
    {
        test_list.insertFront(5);
        test_list.insertFront(7);
